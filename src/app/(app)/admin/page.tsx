...
export default async function AdministrationPage() {
  ...
  const tools = [
    { href: "/messages", title: "Management messages", description: "Send immediate or scheduled management messages to kitchens and named managers.", icon: MessageSquareText, visible: true },
