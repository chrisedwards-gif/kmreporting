  ...
  return (
    <>
      <header className="page-header">
        <div>
          <p className="page-header__eyebrow">Weekly kitchen reporting</p>
          <h1 className="page-header__title">{editableDraft ? "Review, explain, submit." : "Upload the week once."}</h1>
