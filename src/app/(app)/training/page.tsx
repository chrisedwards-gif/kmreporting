...
export default async function TrainingPage() {
  ...
  return (
    <>
      ...
      {profile.isAccessPreview ? <div className="privacy-callout">Admin site mode for {profile.previewSiteName}. You can record sessions, follow-ups and sign-off for this kitchen.</div> : null}
