...
export default async function ProductDevelopmentPage() {
  ...
  const allowGroupWide = profile.siteScopeIds === null;
  ...
  return (
    <>
      ...
      <ProductDevelopmentBoard allowGroupWide={allowGroupWide} canEdit={canEdit} items={items} owners={options.owners} sites={options.sites} />
    </>
  );
}
