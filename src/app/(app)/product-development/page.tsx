...
export default async function ProductDevelopmentPage() {
  ...
  return (
    <>
      ...
      {profile.isAccessPreview ? <div className="privacy-callout">Admin site mode for {profile.previewSiteName}. You can create products, record trials and move work through each stage.</div> : null}
