...
const resultLabel = { in_progress: "In progress", pass: "Pass", watch: "Watch", fail: "Fail" } as const;
...
export default async function KitchenChecksPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <>
      ...
      {profile.isAccessPreview ? <div className="privacy-callout">Read-only preview for {profile.previewSiteName}. A real assigned manager can start, save and submit these checks.</div> : null}
