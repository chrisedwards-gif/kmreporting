...
export default async function OneToOneDetailPage({ params }: { params: Promise<{ reviewId: string }> }) {
  ...
  return (
    <>
      ...
      {profile.isAccessPreview ? <div className="privacy-callout">Kitchen Manager view for {profile.previewSiteName}. Full 1-1 controls remain available through your Admin capabilities.</div> : null}
