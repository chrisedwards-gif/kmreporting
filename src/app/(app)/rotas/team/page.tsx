...
import { RotaCloudPlanningSync } from "@/components/rotas/rota-cloud-sync";
import { RotaOrderManager, type RotaOrderPerson } from "@/components/rotas/rota-order-manager";
import { StaffProfileEditor } from "@/components/rotas/staff-profile-editor";
  ...
  return (
    <>
      ...
      <section aria-label="Rota privacy" className="metric-grid metric-grid--three">
        ...
        <article className="metric-card"><LockKeyhole aria-hidden="true" color="#1e2e35" size={21} /><div className="metric-card__value metric-card__value--compact">One salary source</div><div className="metric-card__note">Salaries and site splits come from Labour settings; the rota never adds them twice</div></article>
