...
import { ArrowRight, Beaker, BookOpenCheck, CalendarDays, ClipboardCheck, GraduationCap, Trash2 } from "lucide-react";
...
const tools = [
  ...
  { href: "/waste", title: "Daily waste log", description: "Capture waste by date and feed it automatically into the correct weekly report.", icon: Trash2 },
...
export default async function KitchenWorkspacePage() {
  ...
  return (
    <>
      <header className="page-header"><div><p className="page-header__eyebrow">Operate</p><h1 className="page-header__title">Kitchen workspace.</h1><p className="page-header__copy">Standards, checks, waste, training, planning and product work in one place.</p></div></header>
