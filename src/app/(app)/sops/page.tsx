...
export default async function SopsPage() {
  ...
  return (
    <>
      ...
      {profile.isAccessPreview ? <div className="privacy-callout">Kitchen Manager view for {profile.previewSiteName}. You can open, add, revise and review this kitchen&apos;s SOPs.</div> : null}
