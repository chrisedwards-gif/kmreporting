...
const kitchenOperationalRoles: AppRole[] = ["admin", "group_manager", "kitchen_manager"];
      ...
      <div className="app-shell__main">
        <header className="app-shell__topbar">
          ...
          <div className="app-shell__topbar-status">
            {user.actualRole === "admin" ? <AccessPreviewControls previewManagerName={user.previewManagerName} previewSiteId={user.previewSiteId} previewSiteName={user.previewSiteName} sites={previewSites} /> : null}
